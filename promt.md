...
анализируй promt.md и реализуй проект по этим требованиям. Для сайта используй https://www.lancer.app/ только как визуальный референс по качеству, ритму, композиции и ощущению премиального SaaS-интерфейса, но не копируй его точь-в-точь: не повторяй бренд, тексты, ассеты, иллюстрации, цвета и защищенные элементы дизайна. Если в проекте чего-то не хватает или что-то сделано слабо, аккуратно исправь это в рамках требований выше и явно помечай mocked/placeholder части там, где backend или продуктовая логика еще не завершены.
